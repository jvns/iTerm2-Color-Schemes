...
These schemes work with any terminal emulator with OSC 4 support (including the Linux console, GNOME Terminal, and more).

Copy the theme content from `generic` and paste the content to `~/bin/set-colors.sh`, or wherever you prefer to put shell scripts.
